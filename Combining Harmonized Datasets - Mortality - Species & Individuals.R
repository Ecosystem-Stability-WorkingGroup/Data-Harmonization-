...
powell.mort.spp.dat <- bind_rows(bio_spp_data_list)%>%
...
str(powell.mort.spp.dat)
unique(powell.mort.spp.dat$data)
length(unique(powell.mort.spp.dat$data))
length(unique(powell.mort.spp.dat$site))

data.test<-powell.mort.spp.dat%>%
...
range(powell.mort.spp.dat$mort_year)
...
#Save Files
write.csv(powell.mort.spp.dat, file="Harmonized.Mortality.Spp.Ind.csv", row.names = F)
############################################################
